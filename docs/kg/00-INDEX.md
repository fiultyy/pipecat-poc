...
| N10 | [10-pool-selection-queen.md](10-pool-selection-queen.md) | **池选型与派生规划**（OF-012/013）：pool/spawn 选型面+策略（default/fanout-sub/binding-mode）+ queen 派生角色 grill 协议 + 池→dsh preset 导出打通 |
