...
async def run_bot(transport: BaseTransport, runner_args: RunnerArguments):
    ...
    # The direct function listed in the context is registered with the LLM
    # automatically. cancel_on_interruption=False (set via @tool_options)
    # makes this an async function call: the LLM continues the conversation
    # immediately and receives updates/result later.
